...
/// Interface for all application events that concern an [OutgoingMessage].
public sealed interface OutgoingMessageEvent {
    ...
    /// Application event published when a message could not be delivered to a recipient within the expected time frame.
    ...
    /// Application event published when a message has been successfully delivered to and acknowledged by a recipient.
    ///
