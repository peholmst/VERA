...
/// A message that has been scheduled for delivery to devices.
///
/// @param messageId  the ID of the message
/// @param recipients a set of at least one device to deliver the message to
