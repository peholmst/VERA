...
@NullMarked
public interface ForStoringTerrainData {

    void saveAddressPoints(Iterable<AddressPoint> addressPoints);

    void saveMunicipalities(Iterable<Municipality> municipalities);

    void savePlaceNames(Iterable<PlaceName> placeNames);

    void saveRoadSegments(Iterable<RoadSegment> roadSegments);
}
